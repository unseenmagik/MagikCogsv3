...
class About:
    ...
    async def about(self, ctx):
        ...
        embed=discord.Embed(title="About Magik Bot V3", url='http://www.magikbot.co.uk', description="The 3rd version of a discord bot made with love. Created for Discord Administration support. With hundreds of commands, admin, mod, support, games, fun and more. For more information see below:", color=0x207cee)
